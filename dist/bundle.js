...
var getFirstTask = function getFirstTask() {
  // 从任务队列中获取任务
  var task = taskQueue.pop(); // 返回最外城节点的filber对象
...
var reconcileChildren = function reconcileChildren(fiber, children) {
  // children可能是对象也可能是数组
  // 将children 转换为数组
  var arrifiedChildren = (0,_Misc__WEBPACK_IMPORTED_MODULE_0__.arrified)(children); // 循环children 使用的索引
  ...
  var prevFiber = null;
  var alternate = null; // 创建 fiber 节点
  ...
  while (index < numberOfElements) {
    ...
    newFiber.stateNode = (0,_Misc__WEBPACK_IMPORTED_MODULE_0__.createStateNode)(newFiber); // 构建节点关系
